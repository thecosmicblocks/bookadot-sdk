...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link bookadotPropertyAbi}__ and `functionName` set to `"bookingHistory"`
 */
export const useReadBookadotPropertyBookingHistory =
...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link bookadotPropertyAbi}__ and `functionName` set to `"bookingsMap"`
 */
export const useReadBookadotPropertyBookingsMap =
  /*#__PURE__*/ createUseReadContract({
    abi: bookadotPropertyAbi,
...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link bookadotPropertyAbi}__ and `functionName` set to `"getBookingIndex"`
 */
export const useReadBookadotPropertyGetBookingIndex =
  /*#__PURE__*/ createUseReadContract({
    abi: bookadotPropertyAbi,
